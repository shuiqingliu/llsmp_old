...
clear
echo "========================================================================="
echo "Install VSFTPD for LLsMP V0.5,  Written by llsmp.cn "
echo "========================================================================="
...
if [ "$ftp_enable" = 'y' ] || [ "$ftp_enable" = 'Y' ]; then
		...
		if [ "$user_exist" != "$ftp_username" ]; then
				...
				read -p "Please input the home directory of the ftp user(e.g. /home/wwwroot ):" directory
				mkdir -p $directory
				useradd -d $directory -s /sbin/nologin $ftp_username -o -u 65534 -g 65534
...
mv -f /etc/vsftpd.conf /etc/vsftpd.conf.bak
