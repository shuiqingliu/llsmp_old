...
if(isset($_GET['generateKeypair'])) {
	...
	if ($mykeys == null) {
		...
		DUtil::my_file_put_contents($keyfile, $serialized_str);
		chmod($keyfile, 0600);
	}
...
if (!$is_https) {
?>
<script type="text/javascript" src="/static/scripts/jcryption/jquery-1.3.2.min.js"></script>
<script type="text/javascript" src="/static/scripts/jcryption/jquery.jcryption-1.0.1.min.js" ></script>
...
<tr class=xtbl_label><td align=center>
<?
if ($client->type == 'LSWS') {
	echo "<img src='/static/images/logo/webserver_small.gif' border=0>";
}
elseif ($client->type == 'LSLB') {
	echo "<img src='/static/images/logo/loadbalancer.gif' border=0>";	
}
?>
</td></tr>
<?
