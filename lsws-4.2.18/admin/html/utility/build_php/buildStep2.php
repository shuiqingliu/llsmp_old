<?
	...
	if ($saved_options != NULL && $check->cur_step == 3) {
...
<table width="100%" class="xtbl" border="0" cellpadding="5" cellspacing="1">
    ...
    <tr class="xtbl_value">
            ...
            ?>
            <input class="xtbl_value" type="text" name="path_env" size="100" value="<?=$options->vals['ExtraPathEnv']?>"></td>
    </tr>
    <tr class="xtbl_value">
            ...
            ?>
            <input class="xtbl_value" type="text" name="installPath" size="100" value="<?=$options->vals['InstallPath']?>"></td>
    </tr>
    <tr class="xtbl_value">
