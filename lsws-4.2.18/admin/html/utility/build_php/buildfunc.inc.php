...
class BuildCheck
{
	...
	function is_suhosin_supported($php_version)
	{
	...
	function validate_step2()
	{
		...
		$options->vals['CompilerFlags'] = escapeshellcmd($compilerFlags);
	...
	function validate_complier_flags(&$cflags)
	{
		if ($cflags === '')
			return TRUE;
...
opcache.enable_cli=1
	...
	function generate_script(&$error)
	{
		...
		$params['{COMPILER_FLAGS}'] = $this->options->vals['CompilerFlags'];
