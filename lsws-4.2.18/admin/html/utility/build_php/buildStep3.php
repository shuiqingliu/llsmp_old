...
<div class="xtbl_header"><p class="xtbl_title">
	Step 3 : Preparing for building PHP <?=$options->vals['PHPVersion']?> Binary
</p>
</div>
...
<input type="hidden" name="php_version" value="<?=$options->vals['PHPVersion']?>">
...
<p><b>Main Status: </b></p>
<div style="margin:10px;border:1px solid rgb(134,142,167);outline: 3px solid #eaeaea;width:940px;height:160px;overflow:auto;font-family:Courier, monospace; font-size: 11px; background: #FFFFF7; color: #333333; padding: 5px 10px;">
<pre id="statuszone"></pre>
</div>
<p><b>Detailed Log: </b></p>
<div style="margin:10px;border:1px solid rgb(134,142,167);outline: 3px solid #eaeaea;width:940px;height:500px;overflow:auto;font-family:Courier, monospace; font-size: 11px; background: #222222; color: #ffffff; padding: 5px 10px;">
<pre id="logzone"></pre>
</div>
<p></p>
