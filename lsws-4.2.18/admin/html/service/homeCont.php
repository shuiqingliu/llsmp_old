...
if($state == "restarted") {
	echo XUI::message("Server Restarted",ucwords(strtolower($product->product))." was gracefully restarted.","success");
...
<tr>
	...
	<td class="icon"><a href="javascript:toggle()"><img alt="Toggle Debug Logging" title="Toggle Debug Logging" src="/static/images/icons/debug.gif"></a></td>
